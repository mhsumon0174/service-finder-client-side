...
const Footer = () => {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <aside className="space-y-3 text-center md:text-left">
          ...
          <p className="text-sm text-gray-500">
            Discover and review trusted services around you. Serving reliably since 1992.
          </p>
        </aside>
  ...
  <div className="grid grid-flow-row gap-4 mt-2">
    ...
    <a href="https://www.youtube.com/c/ProgrammingHeroCommunity" target="_blank" rel="noopener noreferrer">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
        <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path>
      </svg>
    </a>
    <a href="https://www.facebook.com/msdk.sumon" target="_blank" rel="noopener noreferrer">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
        ...
        <nav className='flex flex-col items-center md:block'>
          ...
          <ul className="space-y-2">
            <li><a href="https://web.programming-hero.com/terms-of-service" target="_blank">Terms of Use</a></li>
            <li><a href="https://web.programming-hero.com/terms-of-service" target="_blank">Privacy Policy</a></li>
            <li><a href="https://web.programming-hero.com/terms-of-service" target="_blank">Cookie Policy</a></li>
          </ul>
        </nav>
      </div>
      ...
      <div className="mt-10 border-t pt-6 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} ServFinder. All rights reserved.
      </div>
    </footer>
  );
};
